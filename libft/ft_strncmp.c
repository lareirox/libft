...
/*   Updated: 2025/05/02 16:58:20 by nugoncal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// Teste 1: strings iguais, n menor que o comprimento
	printf("1: %d | %d\n", ft_strncmp("hello", "hello", 3), strncmp("hello", "hello", 3));

	// Teste 2: strings diferentes no início
	printf("2: %d | %d\n", ft_strncmp("abc", "xbc", 3), strncmp("abc", "xbc", 3));

	// Teste 3: strings diferentes depois de alguns caracteres iguais
	printf("3: %d | %d\n", ft_strncmp("abcd", "abcf", 4), strncmp("abcd", "abcf", 4));
